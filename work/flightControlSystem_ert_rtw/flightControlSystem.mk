...
## Generated on : Sun Feb 17 15:29:30 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/parrot/dartmouth_drone/work
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -ID:/parrot/dartmouth_drone/work/slprj/ert/stateEstimator -IC:/Users/dutao/MATLAB/Projects/SLEXAM~1/ASBQUA~3/CONTRO~1 -ID:/parrot/dartmouth_drone/work/slprj/ert/flightController -ID:/parrot/dartmouth_drone/work/slprj/ert/conversionYUV -I$(START_DIR) -I$(START_DIR)/flightControlSystem_ert_rtw -ID:/parrot/dartmouth_drone/controller -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/vision/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(START_DIR)/slprj/ert/_sharedutils -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/parrot/include
...
DEFINES_SKIPFORSIL = -DDELOS -DDELOS_EDU -DEXTMODE_DISABLETESTING -DEXTMODE_STATIC_SIZE=16384 -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DPARROT_LINUX_COMM -DSTACK_SIZE=64 -DRT -DMATFILE_LOGGING=1 -DSTOP_TIME=30 -DROLLINGSPIDER=1
...
OBJS = rt_logging.o flightControlSystem.o flightControlSystem_data.o rsedu_control.o rsedu_of.o rsedu_vis.o controlCommand.o mw_extrathreads.o
