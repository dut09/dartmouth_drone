...
typedef struct {
  ...
  int32_T BlobAnalysis_o3[200];        /* '<S2>/Blob Analysis' */
  real32_T BlobAnalysis_o2[100];       /* '<S2>/Blob Analysis' */
  int32_T BlobAnalysis_o1[50];         /* '<S2>/Blob Analysis' */
...
struct P_FlightControlSystem_flightControlSystem_T_ {
  real_T CompareToConstant_const;      /* Mask Parameter: CompareToConstant_const
                                        ...
                                        */
  real32_T CompareToConstant_const_o;  /* Mask Parameter: CompareToConstant_const_o
  ...
  real32_T CompareToConstant5_const;   /* Mask Parameter: CompareToConstant5_const
                                        ...
                                        */
  statesEstim_t Memory_InitialCondition;/* Computed Parameter: Memory_InitialCondition
  ...
  P_Geofencingerror_flightControlSystem_T estimatorOpticalflowerror;/* '<S3>/estimator//Optical flow error' */
